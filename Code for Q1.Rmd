...
# Draw a boxplot for mean dNdS data with different transmission types
ggplot(dNdSData, aes(x = Transmission_Type, 
                     y = meandNdS, na.rm = TRUE, 
...
# Draw a boxplot for the mutation rate under different transmission types
...
VirTree$tip.label <- paste(rownames(Q1DF5), Q1DF5$Transmission_Type)
TransType <- split(VirTree$tip.label, Q1DF5$Transmission_Type)
